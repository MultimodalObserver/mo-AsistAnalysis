 ...
 * @author Lathy
 */
public class MoAsistAnalysisConfiguration implements PlayableAnalyzableConfiguration  {
    ...
    private List<MoAsistAnalysisVisualization> playables;
    private List<MoAsistAnalysisVisualization> visualizables;
    
    private static final Logger logger = Logger.getLogger(MoAsistAnalysisConfiguration.class.getName());
    ...
    public MoAsistAnalysisConfiguration(String name) {

    }

    public MoAsistAnalysisConfiguration() {
    ...
    public void addPlayable(MoAsistAnalysisVisualization playable) {
        playables.add(playable);
    }

    public void addVisualizable(MoAsistAnalysisVisualization visualizable) {
    ...
    public File toFile(File parent) {
        File f = new File(parent, "asist-analysis_"+id+".xml");
        try {
            f.createNewFile();
    ...
    public Configuration fromFile(File file) {
        ...
        if (fileName.contains("_") && fileName.contains(".")) {
            ...
            MoAsistAnalysisConfiguration config = new MoAsistAnalysisConfiguration ();
            config.id = name;
            return config;
        }
        return null;

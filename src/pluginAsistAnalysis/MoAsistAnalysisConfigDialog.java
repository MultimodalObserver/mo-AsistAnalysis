 ...
 * @author Lathy
 */
public class MoAsistAnalysisConfigDialog extends JDialog implements DocumentListener {
    ...
    public MoAsistAnalysisConfigDialog() {
        super(null, "Asist Analysis Configuration", Dialog.ModalityType.APPLICATION_MODAL);
    }

    MoAsistAnalysisConfigDialog(ProjectOrganization organization) {
        super(null, "Asist Analysis Configuration", Dialog.ModalityType.APPLICATION_MODAL);
        org = organization;
